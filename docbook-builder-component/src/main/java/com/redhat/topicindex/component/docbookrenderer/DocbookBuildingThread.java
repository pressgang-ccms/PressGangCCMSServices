...
public class DocbookBuildingThread extends BaseStompRunnable
{
	...
	{		
		...
		{
			final DocbookBuilder<TopicV1> builder = new DocbookBuilder<TopicV1>(TopicV1.class, this, restClient);
			...
			if (!builder.buildBook(topics, buildDocbookMessage, searchTagsUrl)) {
				this.resendMessage();
			}
		}
		else
	...
	{	
		...
		if (buildDocbookMessage.getDocbookOptions() != null && buildDocbookMessage.getDocbookOptions().isValid())
		{
			final DocbookBuilder<TranslatedTopicV1> builder = new DocbookBuilder<TranslatedTopicV1>(TranslatedTopicV1.class, this, restClient);
